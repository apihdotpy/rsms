...
include "config.php";
  ...
  if (isset($_POST['Submit'])) {
    ...
    $sql= "UPDATE stock SET stockid='$stockid', stockName='$stocName',stockIn='$newStock',stockOut='$stockOut', AvailableStock = $stockAvailable WHERE  stockid='$stockid'";
    ...
    if ($result == TRUE) {
     ...
     echo ("<script LANGUAGE='JavaScript'>
                ...
                window.location.href='staffstocklist.php';
                </script>");;
                ...
                <form action="" method="POST" style="width;50vw; min-width: 300px;">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="stockid" value="<?php echo $row['stockid']?>">
                        </div>
                </div>
                <div>
