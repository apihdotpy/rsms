...
$result = mysqli_query($conn, $query);
      while ($row = mysqli_fetch_assoc($result)) {
          ?>
              ...
              <td>
                   <a href="updateRS.php?stockid=<?php echo $row['id']?>" class="link-dark"><i title ="Edit"class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                   <a href="DeleteRS.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure want to delete?'); " class="link-dark" ><i title ="Delete" class="fa-solid fa-trash fs-5"></i></a>
