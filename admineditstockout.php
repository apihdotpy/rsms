...
include "config.php";
  ...
  if (isset($_POST['Submit'])) {
    ...
    $newOut= $AvailableStock-$stockOut;

    $iqinidola = $_POST['iqinidola'];

    $tambah = $iqinidola +   $stockOut;
    ...
    $sql= "UPDATE stock SET stockOut='$tambah', AvailableStock = $newOut WHERE  stockid='$stockid'";
            ...
            <div class="container d-flex justify-content-center">
                ...
                <div>
                   ...
                   <div>
                    ...
                    <input type="text" class="form-control" name="stockOut" value="<?php echo $row['StockOut']?>">
                </div>
                 <div>
                    <input type="hidden" class="form-control" name="AvailableStock"  value="<?php echo $row['AvailableStock']?>">
                </div>
                  <div>
                    <input type="hidden" class="form-control" name="iqinidola"  value="<?php echo $row['StockOut']?>">
                </div>
                <br>
                <br>
                <div> 
