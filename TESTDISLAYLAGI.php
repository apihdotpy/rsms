     ...
     if (isset($_GET['search']))
      {
        ...
        $query = "SELECT requeststock.*, supplier.suppName, stock.stockName FROM requeststock, supplier, stock WHERE CONCAT(supplier.suppName,stock.stockName) LIKE '%$filtervalues%' AND supplier.id = requeststock.SuppName AND stock.stockid = requeststock.ItemName        ";
    } else{
      $query = "SELECT requeststock.*, supplier.suppName, stock.stockName FROM requeststock, supplier, stock ORDER BY requeststock.ItemName ASC";
}
          ...
          ?>
            ...
            <th><?php echo $row['Description']?></th>
              ...
              <td>
                   ...
                   <a href="DeleteRS.php?ReqId=<?php echo $row['ReqId']; ?>" onclick="return confirm('Are you sure want to delete?'); " class="link-dark" ><i title ="Delete" class="fa-solid fa-trash fs-5"></i></a>
