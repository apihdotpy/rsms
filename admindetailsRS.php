...
<html>
    ...
    <?php $id=$_GET['id'];?>
        <a class="active" href="" style="color:white;"><i class="fa fa-fw fa-home" style="color:white;"></i> Home</a> 
        ...
        <div class="container" style="padding-top: 70px;">
            <a href="staffRS.php" class="btn btn-dark mb-3">New Request</a>
...
$result = mysqli_query($conn, $query);
      while ($row = mysqli_fetch_assoc($result)) {
          ?>
              ...
              <td>
                   <a href="adminupdateRS.php?stockid=<?php echo $row['id']?>" class="link-dark"><i title ="Edit"class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                   <a href="admindeleteRS.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure want to delete?'); " class="link-dark" ><i title ="Delete" class="fa-solid fa-trash fs-5"></i></a>
