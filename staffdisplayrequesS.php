...
<html>
    <head>
        <title>List Stock Request </title>
        <meta charset="UTF-8">
    ...
    <?php $id=$_GET['id'];?>
        ...
        <div class="container" style="padding-top: 70px;">
            <a href="Adminaddstock.php" class="btn btn-dark mb-3">Request Stock</a>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          ?>
              ...
              <td>
                   ...
                   <a href="adminupdateStock.php?stockid=<?php echo $row['stockid']?>" class="link-dark"><i title ="Edit"class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
