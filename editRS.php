...
if (isset($_POST['Submit'])) {
    ...
    $sql= "UPDATE requeststock SET DateReq ='$DateReq',SuppName='$SuppName', ItemName='$ItemName', WHERE  ReqId='$ReqID'";
        ...
        <div class="card-body">
          ...
          <form action="" method="POST">
            <table class="table">
              ...
              <tbody>
                ...
                if (isset($_GET['select'])) {
                  ...
                  while ($row = mysqli_fetch_assoc($result2)) {
                    ?>
                    <tr>
                      <th><input type="checkbox" name="cb[]" value="<?php echo $row['stockid'] ?>"
              ...
              <input type="submit" name="submit" value="Update" class="btn btn-primary d-block">
          </form>
        </div>
</body>
