...
if (isset($_POST['Submit'])) {
    ...
    $id = $_POST['staffusername'];
    $staffNum = $_POST['staffNum'];
    $stuffEmail = $_POST['stuffEmail'];
    $staffAdd = $_POST['staffAdd'];

    $sql = "UPDATE staff SET staffName = '$staffName', staffNum = '$staffNum', stuffEmail = '$stuffEmail' WHERE id = '$stid'";
    $result = $conn->query($sql);

    if ($result == TRUE) {
        echo ("<script LANGUAGE='JavaScript'>
                window.alert('Successfully updated');
                window.location.href = 'staffdisplayprofile.php?id=$stid';
              </script>");
    } else {
        ...
        <div class="container" style="padding-top: 70px;">
            ...
            <div class="container d-flex justify-content-center">
                ...
                <div> 
                    ...
                    <?php $id=$_GET['id'];?>
                    <a href="staffdisplayprofile.php?id=<?php echo $id;?>" class="btn btn-danger">Cancel</a>
                </div>
<?php
}
?>
