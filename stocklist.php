...
<html>
    ...
    <div class="container-fluid">
        ...
        <div class="container" style="padding-top: 70px;">
            <a href="addstock.php" class="btn btn-dark mb-3">Add New</a>
     ...
     if (isset($_GET['search']))
      {
        ...
        $query = "SELECT * FROM stock WHERE CONCAT(stockName,stockid) LIKE '%$filtervalues%'";
    } else{
      $query = "SELECT * FROM  stock  ORDER BY stockid ASC";
}
      ...
      while ($row = mysqli_fetch_assoc($result)) {
          ?>
              ...
              <td>
                   ...
                   <a href="deletestock.php?stockid=<?php echo $row['stockid']; ?>" onclick="return confirm('Are you sure want to delete?'); " class="link-dark" ><i title ="Delete" class="fa-solid fa-trash fs-5"></i></a>
